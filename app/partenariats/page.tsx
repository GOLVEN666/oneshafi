...
export default function PartnershipsPage() {
  const [modalType, setModalType] = useState<"ambassadeur" | "partenaire" | "revendeur" | null>(null)

  const openModal = (type: "ambassadeur" | "partenaire" | "revendeur") => {
    setModalType(type)
  }
  ...
  return (
    <div>
              ...
              >
                ...
                <div className="text-center">
                  <div className="flex flex-col sm:flex-row gap-2 justify-center">
                    <Link href={`/partenariats/${partnership.id}`} className="btn-secondary">
                      En savoir plus
                    </Link>
                    <button
                      onClick={() => openModal(partnership.id as "ambassadeur" | "partenaire" | "revendeur")}
      ...
      {/* Partnership Modal */}
      {modalType && (
        <PartnershipModal isOpen={modalType !== null} onClose={closeModal} type={modalType} title={getModalTitle()} />
      )}
    </div>
  )
}
