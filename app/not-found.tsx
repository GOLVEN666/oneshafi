  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(ellipse_at_center,_rgba(255,254,234,1)_0%,_rgba(255,254,234,1)_35%,_#B7E8EB_100%)]">
      <div className="flex items-center justify-center min-h-screen">
        <div className="z-10 flex flex-col items-center justify-center w-full max-w-md px-4">
          <motion.div
          ...
          >
            ...
            <p className="text-[#234B4B]/80">Désolé, la page que vous recherchez n'existe pas.</p>
